...
#define initial_sidetone_freq 1000        // "factory default" sidetone frequency setting
...
#define initial_pot_wpm_low_value 7 //13     // Potentiometer WPM fully CCW
#define initial_pot_wpm_high_value 20 //35    // Potentiometer WPM fully CW
#define wpm_limit_low 2
#define wpm_limit_high 30 //60  
